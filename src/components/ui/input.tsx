...
function InputPassword({ className, icon, ...props }: InputProps) {
  ...
  return (
    <div className="relative w-full">
      ...
      <button
        ...
        className="absolute right-3 top-1/2 -translate-y-1/2 text-input-placeholder hover:text-foreground"
      >
        {showPassword ? (
          <EyeSlashIcon weight="bold" className="h-5 w-5" />
        ) : (

  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdowns: cn(
          "flex h-(--cell-size) z-10 w-full items-center justify-center gap-1.5 text-sm font-medium",
      ...
      components={{
        ...
        Dropdown: ({ value, onChange, options, ...props }) => {
          ...
          return (
            ...
            >
              <SelectTrigger className="h-8 w-fit gap-1 border-none shadow-none bg-transparent hover:bg-transparent hover:text-accent-foreground pr-1.5 focus:ring-0 font-medium text-sm">
